...
This command allows users of the AddressBook application to add optional remarks to people in their npc_track and
...
/**
 * Changes the remark of an existing person in the npc_track.
 */
...
doing so will cause AddressBook to default to an empty npc_track!
